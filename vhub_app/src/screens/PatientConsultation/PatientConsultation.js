...
export const PatientConsultation = ({ navigation, route }) => {
    ...
    const [consultaCancel, setConsultaCancel] = useState({
        id: '',
        situacaoId: 'ABF779F2-39A5-46D9-91D6-DB73D412FBFD'
    })
    ...
    const [showModalAppo, setShowModalAppo] = useState(false)
    ...
    return (
        ...
        <Container>
            ...
            <ButtonHomeContainer>
                ...
                <FilterButton onPress={() => { setSelected("Pendente") }} selected={selected === 'Pendente' ? true : false} text={'Agendadas'} />
            ...
            <FlatContainer
                ...
                renderItem={({ item }) => {
                    ...
                    if (situacao === selected) {
                        return (
                            <Card
                                onPressMap={setConsultaSelecionada(item)}
                                setShowModalAppo={setShowModalAppo}
                                ...
                                onPressCancel={() => { MostrarModal('cancelar', item), setConsultaCancel(() => ({ situacaoId: 'ABF779F2-39A5-46D9-91D6-DB73D412FBFD', id: item.id })), ListarConsultas() }}
            ...
            <PatientAppointmentModal
                ...
                navigation={navigation}
                visible={showModalAppo}
                setShowModal={setShowModalAppo}
            />
